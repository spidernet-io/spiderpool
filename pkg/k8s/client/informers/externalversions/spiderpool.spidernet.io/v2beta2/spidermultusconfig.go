...
type SpiderMultusConfigInformer interface {
	...
	Lister() v2beta2.SpiderMultusConfigLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SpiderpoolV2beta2().SpiderMultusConfigs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpiderpoolV2beta2().SpiderMultusConfigs(namespace).Watch(context.TODO(), options)
			},
		},
		&spiderpoolspidernetiov2beta2.SpiderMultusConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *spiderMultusConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&spiderpoolspidernetiov2beta2.SpiderMultusConfig{}, f.defaultInformer)
}

func (f *spiderMultusConfigInformer) Lister() v2beta2.SpiderMultusConfigLister {
	return v2beta2.NewSpiderMultusConfigLister(f.Informer().GetIndexer())
}
