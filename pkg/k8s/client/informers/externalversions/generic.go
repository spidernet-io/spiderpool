...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1.SchemeGroupVersion.WithResource("spidercoordinators"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Spiderpool().V1().SpiderCoordinators().Informer()}, nil
	...
	case v1.SchemeGroupVersion.WithResource("spidermultusconfigs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Spiderpool().V1().SpiderMultusConfigs().Informer()}, nil
