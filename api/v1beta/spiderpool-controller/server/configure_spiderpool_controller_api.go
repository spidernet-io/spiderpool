...
import (
	...
	"github.com/spidernet-io/spiderpool/api/v1beta/spiderpool-controller/server/restapi"
...
//go:generate swagger generate server --target ../../spiderpool-controller --name SpiderpoolControllerAPI --spec ../swagger.yml --api-package restapi --server-package server --principal interface{} --default-scheme unix --exclude-main
