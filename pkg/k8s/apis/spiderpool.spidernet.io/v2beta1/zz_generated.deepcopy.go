...
func (in *IPPoolStatus) DeepCopyInto(out *IPPoolStatus) {
	*out = *in
	...
	if in.IaasReadyIPs != nil {
		in, out := &in.IaasReadyIPs, &out.IaasReadyIPs
		*out = make([]IaasReadyIPAllocation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.IaasFailedIPs != nil {
		in, out := &in.IaasFailedIPs, &out.IaasFailedIPs
		*out = make([]IaasFailedIPAllocation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IaasFailedIPAllocation) DeepCopyInto(out *IaasFailedIPAllocation) {
	*out = *in
	if in.IPv4 != nil {
		in, out := &in.IPv4, &out.IPv4
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IaasFailedIPAllocation.
func (in *IaasFailedIPAllocation) DeepCopy() *IaasFailedIPAllocation {
	if in == nil {
		return nil
	}
	out := new(IaasFailedIPAllocation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IaasReadyIPAllocation) DeepCopyInto(out *IaasReadyIPAllocation) {
	*out = *in
	if in.IPv4 != nil {
		in, out := &in.IPv4, &out.IPv4
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IaasReadyIPAllocation.
func (in *IaasReadyIPAllocation) DeepCopy() *IaasReadyIPAllocation {
	if in == nil {
		return nil
	}
	out := new(IaasReadyIPAllocation)
	in.DeepCopyInto(out)
	return out
}
