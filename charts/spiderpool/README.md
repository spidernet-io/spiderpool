...
| `multus.multusCNI.defaultCniCRName`           | it will create the NetworkAttachmentDefinition name for default CNI, if this value is empty, multus will automatically get default CNI according to the existed CNI conf file in /etc/cni/net.d/ | `""`                              |
