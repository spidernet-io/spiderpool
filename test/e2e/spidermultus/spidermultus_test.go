...
var _ = Describe("test spidermultus", Label("SpiderMultusConfig"), func() {
	...
	It("rdma must be enabled and ippools config must be set when spidermutlus with annotation: cni.spidernet.io/rdma-resource-inject", Label("M00023"), func() {
	...
	It("return an err if rdma is not enabled when spidermutlus with annotation: cni.spidernet.io/rdma-resource-inject", Label("M00023"), func() {
		var smcName string = "ann-rdma-resource" + common.GenerateString(10, true)
		smc := &spiderpoolv2beta1.SpiderMultusConfig{
			ObjectMeta: metav1.ObjectMeta{
				Name:      smcName,
	...
	It("return an err if no ippools config when spidermutlus with annotation: cni.spidernet.io/rdma-resource-inject", Label("M00023"), func() {
		var smcName string = "ann-rdma-resource" + common.GenerateString(10, true)
		smc := &spiderpoolv2beta1.SpiderMultusConfig{
			ObjectMeta: metav1.ObjectMeta{
				Name:      smcName,
	...
	It("return an err if cniType is not in [macvlan,ipvlan,sriov,ib-sriov,ipoib] when spidermutlus with annotation: cni.spidernet.io/rdma-resource-inject", Label("M00023"), func() {
		var smcName string = "ann-rdma-resource" + common.GenerateString(10, true)
		smc := &spiderpoolv2beta1.SpiderMultusConfig{
			ObjectMeta: metav1.ObjectMeta{
				Name:      smcName,
