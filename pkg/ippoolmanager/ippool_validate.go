...
func validateIPPoolGateway(ipPool *spiderpoolv1.SpiderIPPool) *field.Error {
...
func validateIPPoolPodAffinity(fieldPath *field.Path, ipPool *spiderpoolv1.SpiderIPPool) field.ErrorList {
