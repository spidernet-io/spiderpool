...
type Interface interface {
	...
	SpiderpoolV2beta2() spiderpoolv2beta2.SpiderpoolV2beta2Interface
}
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	spiderpoolV2beta2 *spiderpoolv2beta2.SpiderpoolV2beta2Client
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	cs.spiderpoolV2beta2, err = spiderpoolv2beta2.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	...
	cs.spiderpoolV2beta2 = spiderpoolv2beta2.New(c)
