...
// +kubebuilder:rbac:groups="resource.k8s.io",resources=resourceclaims;deviceclasses;resourceclaimtemplates,verbs=get;list;watch
// +kubebuilder:rbac:groups="resource.k8s.io",resources=resourceslices,verbs=create;get;list;patch;watch;update;delete
