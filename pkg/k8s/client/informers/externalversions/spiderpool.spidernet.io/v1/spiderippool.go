	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SpiderpoolV1().SpiderIPPools().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpiderpoolV1().SpiderIPPools().Watch(context.TODO(), options)
			},
		},
		&spiderpoolspidernetiov1.SpiderIPPool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *spiderIPPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&spiderpoolspidernetiov1.SpiderIPPool{}, f.defaultInformer)
}

func (f *spiderIPPoolInformer) Lister() v1.SpiderIPPoolLister {
	return v1.NewSpiderIPPoolLister(f.Informer().GetIndexer())
}
