...
type SpiderCoordinatorInformer interface {
	...
	Lister() v2beta2.SpiderCoordinatorLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SpiderpoolV2beta2().SpiderCoordinators().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpiderpoolV2beta2().SpiderCoordinators().Watch(context.TODO(), options)
			},
		},
		&spiderpoolspidernetiov2beta2.SpiderCoordinator{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *spiderCoordinatorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&spiderpoolspidernetiov2beta2.SpiderCoordinator{}, f.defaultInformer)
}

func (f *spiderCoordinatorInformer) Lister() v2beta2.SpiderCoordinatorLister {
	return v2beta2.NewSpiderCoordinatorLister(f.Informer().GetIndexer())
}
