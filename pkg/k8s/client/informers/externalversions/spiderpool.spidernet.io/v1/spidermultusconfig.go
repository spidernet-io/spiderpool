...
type SpiderMultusConfigInformer interface {
	...
	Lister() v1.SpiderMultusConfigLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SpiderpoolV1().SpiderMultusConfigs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpiderpoolV1().SpiderMultusConfigs(namespace).Watch(context.TODO(), options)
			},
		},
		&spiderpoolspidernetiov1.SpiderMultusConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *spiderMultusConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&spiderpoolspidernetiov1.SpiderMultusConfig{}, f.defaultInformer)
}

func (f *spiderMultusConfigInformer) Lister() v1.SpiderMultusConfigLister {
	return v1.NewSpiderMultusConfigLister(f.Informer().GetIndexer())
}
