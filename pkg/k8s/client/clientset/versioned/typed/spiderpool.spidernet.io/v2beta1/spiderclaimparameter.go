...
type SpiderClaimParameterInterface interface {
	Create(ctx context.Context, spiderClaimParameter *v2beta1.SpiderClaimParameter, opts v1.CreateOptions) (*v2beta1.SpiderClaimParameter, error)
	Update(ctx context.Context, spiderClaimParameter *v2beta1.SpiderClaimParameter, opts v1.UpdateOptions) (*v2beta1.SpiderClaimParameter, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v2beta1.SpiderClaimParameter, error)
	List(ctx context.Context, opts v1.ListOptions) (*v2beta1.SpiderClaimParameterList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2beta1.SpiderClaimParameter, err error)
...
func newSpiderClaimParameters(c *SpiderpoolV2beta1Client, namespace string) *spiderClaimParameters {
...
func (c *spiderClaimParameters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2beta1.SpiderClaimParameter, err error) {
	result = &v2beta1.SpiderClaimParameter{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *spiderClaimParameters) List(ctx context.Context, opts v1.ListOptions) (result *v2beta1.SpiderClaimParameterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2beta1.SpiderClaimParameterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("spiderclaimparameters").
...
func (c *spiderClaimParameters) Create(ctx context.Context, spiderClaimParameter *v2beta1.SpiderClaimParameter, opts v1.CreateOptions) (result *v2beta1.SpiderClaimParameter, err error) {
	result = &v2beta1.SpiderClaimParameter{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("spiderclaimparameters").
...
func (c *spiderClaimParameters) Update(ctx context.Context, spiderClaimParameter *v2beta1.SpiderClaimParameter, opts v1.UpdateOptions) (result *v2beta1.SpiderClaimParameter, err error) {
	result = &v2beta1.SpiderClaimParameter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spiderclaimparameters").
...
func (c *spiderClaimParameters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2beta1.SpiderClaimParameter, err error) {
	result = &v2beta1.SpiderClaimParameter{}
