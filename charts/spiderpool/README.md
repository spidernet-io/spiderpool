...
| `spiderpoolAgent.prometheus.hostContainerNetNsPath`                                  | the host path of the container network namespace directory (Docker: /run/docker/netns, containerd: /var/run/netns)                                                               | `/var/run/netns`                           |
