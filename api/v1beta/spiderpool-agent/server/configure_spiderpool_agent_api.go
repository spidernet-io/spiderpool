...
import (
	...
	"github.com/spidernet-io/spiderpool/api/v1beta/spiderpool-agent/server/restapi"
	"github.com/spidernet-io/spiderpool/api/v1beta/spiderpool-agent/server/restapi/connectivity"
	"github.com/spidernet-io/spiderpool/api/v1beta/spiderpool-agent/server/restapi/daemonset"
	runtimeops "github.com/spidernet-io/spiderpool/api/v1beta/spiderpool-agent/server/restapi/runtime"
)

//go:generate swagger generate server --target ../../spiderpool-agent --name SpiderpoolAgentAPI --spec ../swagger.yml --api-package restapi --server-package server --principal interface{} --default-scheme unix --exclude-main
