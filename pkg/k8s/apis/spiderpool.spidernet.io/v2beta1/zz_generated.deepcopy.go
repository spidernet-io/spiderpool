...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPMetaData) DeepCopyInto(out *IPMetaData) {
	*out = *in
	if in.Metadata != nil {
	...
	if in.UnreadyIPCount != nil {
		in, out := &in.UnreadyIPCount, &out.UnreadyIPCount
		*out = new(int64)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPMetaData.
func (in *IPMetaData) DeepCopy() *IPMetaData {
	if in == nil {
		return nil
	}
	out := new(IPMetaData)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPMetadataEntry) DeepCopyInto(out *IPMetadataEntry) {
	*out = *in
	if in.IPv6 != nil {
		in, out := &in.IPv6, &out.IPv6
		*out = new(string)
	...
	if in.DetachTime != nil {
		in, out := &in.DetachTime, &out.DetachTime
		*out = (*in).DeepCopy()
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPMetadataEntry.
func (in *IPMetadataEntry) DeepCopy() *IPMetadataEntry {
	if in == nil {
		return nil
	}
	out := new(IPMetadataEntry)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IPPoolStatus) DeepCopyInto(out *IPPoolStatus) {
	*out = *in
	...
	if in.IPMetaData != nil {
		in, out := &in.IPMetaData, &out.IPMetaData
		*out = new(IPMetaData)
		(*in).DeepCopyInto(*out)
	}
	if in.ParentNic != nil {
		in, out := &in.ParentNic, &out.ParentNic
		*out = new(ParentNicStatus)
		**out = **in
	}
}
...
func (in *LogOptions) DeepCopyInto(out *LogOptions) {
	*out = *in
	...
	if in.LogFileMaxAge != nil {
		in, out := &in.LogFileMaxAge, &out.LogFileMaxAge
		*out = new(int32)
		**out = **in
	}
...
func (in *MultusCNIConfigSpec) DeepCopyInto(out *MultusCNIConfigSpec) {
	*out = *in
	...
	if in.VlanConfig != nil {
		...
		*out = new(SpiderVlanCniConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.EniVlanConfig != nil {
		in, out := &in.EniVlanConfig, &out.EniVlanConfig
		*out = new(SpiderEniVlanCniConfig)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParentNicStatus) DeepCopyInto(out *ParentNicStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParentNicStatus.
func (in *ParentNicStatus) DeepCopy() *ParentNicStatus {
	if in == nil {
		return nil
	}
	out := new(ParentNicStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpiderEniVlanCniConfig) DeepCopyInto(out *SpiderEniVlanCniConfig) {
	*out = *in
	if in.Master != nil {
	...
	if in.ValidateIaasNetConfig != nil {
		in, out := &in.ValidateIaasNetConfig, &out.ValidateIaasNetConfig
		*out = new(bool)
		**out = **in
	}
	if in.ValidationRetries != nil {
		in, out := &in.ValidationRetries, &out.ValidationRetries
		*out = new(int32)
		**out = **in
	}
	if in.ValidationTimeoutMs != nil {
		in, out := &in.ValidationTimeoutMs, &out.ValidationTimeoutMs
		*out = new(int32)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpiderEniVlanCniConfig.
func (in *SpiderEniVlanCniConfig) DeepCopy() *SpiderEniVlanCniConfig {
	if in == nil {
		return nil
	}
	out := new(SpiderEniVlanCniConfig)
...
func (in *SpiderIBSriovCniConfig) DeepCopyInto(out *SpiderIBSriovCniConfig) {
	*out = *in
	...
	if in.EnableIbKubernetes != nil {
		in, out := &in.EnableIbKubernetes, &out.EnableIbKubernetes
		*out = new(bool)
		**out = **in
	}
	if in.SpiderpoolConfigPools != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpiderIPAMConfig) DeepCopyInto(out *SpiderIPAMConfig) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpiderIPAMConfig.
func (in *SpiderIPAMConfig) DeepCopy() *SpiderIPAMConfig {
	if in == nil {
		return nil
	}
	out := new(SpiderIPAMConfig)
...
func (in *SpiderIPvlanCniConfig) DeepCopyInto(out *SpiderIPvlanCniConfig) {
	*out = *in
	...
	if in.RdmaResourceName != nil {
		in, out := &in.RdmaResourceName, &out.RdmaResourceName
		*out = new(string)
		**out = **in
	}
	if in.SpiderpoolConfigPools != nil {
...
func (in *SpiderpoolPools) DeepCopyInto(out *SpiderpoolPools) {
	*out = *in
	if in.MatchMasterSubnet != nil {
		in, out := &in.MatchMasterSubnet, &out.MatchMasterSubnet
		*out = new(bool)
		**out = **in
	}
