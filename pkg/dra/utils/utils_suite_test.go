...
var _ = BeforeSuite(func() {
	...
	err = resourcev1alpha2.AddToScheme(scheme)
	...
	fakeClient = fake.NewClientBuilder().
		...
		WithIndex(&resourcev1alpha2.ResourceClaimTemplate{}, metav1.ObjectNameField, func(raw client.Object) []string {
			rct := raw.(*resourcev1alpha2.ResourceClaimTemplate)
			return []string{rct.GetObjectMeta().GetName()}
		}).
		Build()
