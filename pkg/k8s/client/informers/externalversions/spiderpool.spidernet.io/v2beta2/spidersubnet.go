...
type SpiderSubnetInformer interface {
	...
	Lister() v2beta2.SpiderSubnetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SpiderpoolV2beta2().SpiderSubnets().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpiderpoolV2beta2().SpiderSubnets().Watch(context.TODO(), options)
			},
		},
		&spiderpoolspidernetiov2beta2.SpiderSubnet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *spiderSubnetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&spiderpoolspidernetiov2beta2.SpiderSubnet{}, f.defaultInformer)
}

func (f *spiderSubnetInformer) Lister() v2beta2.SpiderSubnetLister {
	return v2beta2.NewSpiderSubnetLister(f.Informer().GetIndexer())
}
