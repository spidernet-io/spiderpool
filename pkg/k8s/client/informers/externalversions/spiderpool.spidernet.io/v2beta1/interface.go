...
type Interface interface {
	// SpiderCNIConfigs returns a SpiderCNIConfigInformer.
	SpiderCNIConfigs() SpiderCNIConfigInformer
...
// SpiderCNIConfigs returns a SpiderCNIConfigInformer.
func (v *version) SpiderCNIConfigs() SpiderCNIConfigInformer {
	return &spiderCNIConfigInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
