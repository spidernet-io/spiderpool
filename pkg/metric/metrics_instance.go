...
const (
	...
	ipamAllocationCountsName                     = metricPrefix + "ipam_allocation_counts"
	ipamAllocationFailureCountsName              = metricPrefix + "ipam_allocation_failure_counts"
	ipamAllocationUpdateIPPoolConflictCountsName = metricPrefix + "ipam_allocation_update_ippool_conflict_counts"
	ipamAllocationErrInternalCountsName          = metricPrefix + "ipam_allocation_err_internal_counts"
	ipamAllocationErrNoAvailablePoolCountsName   = metricPrefix + "ipam_allocation_err_no_available_pool_counts"
	ipamAllocationErrRetriesExhaustedCountsName  = metricPrefix + "ipam_allocation_err_retries_exhausted_counts"
	ipamAllocationErrIPUsedOutCountsName         = metricPrefix + "ipam_allocation_err_ip_used_out_counts"

	ipamAllocationAverageDurationSecondsName = metricPrefix + "ipam_allocation_average_duration_seconds"
	ipamAllocationMaxDurationSecondsName     = metricPrefix + "ipam_allocation_max_duration_seconds"
	ipamAllocationMinDurationSecondsName     = metricPrefix + "ipam_allocation_min_duration_seconds"
	ipamAllocationLatestDurationSecondsName  = metricPrefix + "ipam_allocation_latest_duration_seconds"
	ipamAllocationDurationSecondsName        = metricPrefix + "ipam_allocation_duration_seconds"

	ipamAllocationAverageLimitDurationSecondsName = metricPrefix + "ipam_allocation_average_limit_duration_seconds"
	ipamAllocationMaxLimitDurationSecondsName     = metricPrefix + "ipam_allocation_max_limit_duration_seconds"
	ipamAllocationMinLimitDurationSecondsName     = metricPrefix + "ipam_allocation_min_limit_duration_seconds"
	ipamAllocationLatestLimitDurationSecondsName  = metricPrefix + "ipam_allocation_latest_limit_duration_seconds"
	ipamAllocationLimitDurationSecondsName        = metricPrefix + "ipam_allocation_limit_duration_seconds"

	// spiderpool agent ipam release metrics name
	ipamReleaseCountsName                     = metricPrefix + "ipam_release_counts"
	ipamReleaseFailureCountsName              = metricPrefix + "ipam_release_failure_counts"
	ipamReleaseUpdateIPPoolConflictCountsName = metricPrefix + "ipam_release_update_ippool_conflict_counts"
	ipamReleaseErrInternalCountsName          = metricPrefix + "ipam_release_err_internal_counts"
	ipamReleaseErrRetriesExhaustedCountsName  = metricPrefix + "ipam_release_err_retries_exhausted_counts"

	ipamReleaseAverageDurationSecondsName = metricPrefix + "ipam_release_average_duration_seconds"
	ipamReleaseMaxDurationSecondsName     = metricPrefix + "ipam_release_max_duration_seconds"
	ipamReleaseMinDurationSecondsName     = metricPrefix + "ipam_release_min_duration_seconds"
	ipamReleaseLatestDurationSecondsName  = metricPrefix + "ipam_release_latest_duration_seconds"
	ipamReleaseDurationSecondsName        = metricPrefix + "ipam_release_duration_seconds"

	ipamReleaseAverageLimitDurationSecondsName = metricPrefix + "ipam_release_average_limit_duration_seconds"
	ipamReleaseMaxLimitDurationSecondsName     = metricPrefix + "ipam_release_max_limit_duration_seconds"
	ipamReleaseMinLimitDurationSecondsName     = metricPrefix + "ipam_release_min_limit_duration_seconds"
	ipamReleaseLatestLimitDurationSecondsName  = metricPrefix + "ipam_release_latest_limit_duration_seconds"
	ipamReleaseLimitDurationSecondsName        = metricPrefix + "ipam_release_limit_duration_seconds"

	// spiderpool controller IP GC metrics name
	ipGCCCountsName       = metricPrefix + "ip_gc_counts"
	ipGCFailureCountsName = metricPrefix + "ip_gc_failure_counts"

	// spiderpool IPPool and Subnet metrics and these include some debug level metrics
	totalIPPoolCountsName                = metricPrefix + "total_ippool_counts"
	ippoolTotalIPCountsName              = metricPrefix + debugPrefix + "ippool_total_ip_counts"
	ippoolAvailableIPCountsName          = metricPrefix + debugPrefix + "ippool_available_ip_counts"
	totalSubnetCountsName                = metricPrefix + "total_subnet_counts"
	subnetIPPoolCountsName               = metricPrefix + debugPrefix + "subnet_ippool_counts"
	subnetTotalIPCountsName              = metricPrefix + debugPrefix + "subnet_total_ip_counts"
	subnetAvailableIPCountsName          = metricPrefix + debugPrefix + "subnet_available_ip_counts"
	autoPoolWaitedForAvailableCountsName = metricPrefix + debugPrefix + "auto_pool_waited_for_available_counts"
)
