...
func (in *IPPoolStatus) DeepCopyInto(out *IPPoolStatus) {
	*out = *in
	...
	if in.IaasIPs != nil {
		in, out := &in.IaasIPs, &out.IaasIPs
		*out = make([]IaasIPAllocation, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IaasIPAllocation) DeepCopyInto(out *IaasIPAllocation) {
	*out = *in
	if in.IPv4 != nil {
		in, out := &in.IPv4, &out.IPv4
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IaasIPAllocation.
func (in *IaasIPAllocation) DeepCopy() *IaasIPAllocation {
	if in == nil {
		return nil
	}
	out := new(IaasIPAllocation)
	in.DeepCopyInto(out)
	return out
}
