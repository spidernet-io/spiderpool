...
// Source: ./pkg/podmanager/pod_manager.go
...
func (m *MockPodManager) GetPodTopController(ctx context.Context, pod *v1.Pod) (string, v10.Object, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPodTopController", ctx, pod)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(v10.Object)
	ret2, _ := ret[2].(error)
