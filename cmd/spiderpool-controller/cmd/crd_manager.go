...
func newCRDManager() (ctrl.Manager, error) {
	...
	if err := mgr.GetFieldIndexer().IndexField(controllerContext.InnerCtx, &spiderpoolv1.SpiderSubnet{}, "spec.default", func(raw client.Object) []string {
	...
	if err := mgr.GetFieldIndexer().IndexField(controllerContext.InnerCtx, &spiderpoolv1.SpiderIPPool{}, "spec.default", func(raw client.Object) []string {
