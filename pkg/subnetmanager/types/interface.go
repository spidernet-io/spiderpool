...
type SubnetManager interface {
	...
	AllocateEmptyIPPool(ctx context.Context, subnetMgrName string, appKind string, app metav1.Object, ipNum int, ipVersion types.IPVersion, reclaimIPPool bool) error
